...
| `AGENT.md` | The **generated** universal agents.md spec, synthesized from the three briefs with all four anti-pattern lists embedded inline. Always written. |
...
orchestrator generates. `AGENT.md` is always written; the harness-specific files
