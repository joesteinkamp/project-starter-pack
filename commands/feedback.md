...
Run the corrective feedback flow on one of the project's generated briefs (`PRODUCT.md`, `DESIGN.md`, `CODE.md`, `AGENT.md`, `CLAUDE.md`):
...
3. Read the affected file. If the file is derived (`AGENT.md` / `CLAUDE.md`), also read the source brief(s) and prefer a source-brief fix.
