...
1. The questionnaire bank is at `../../questionnaires/code.questions.md`. The template is at `../../templates/CODE.template.md`. The anti-pattern guardrails are at `../../guardrails/code-anti-patterns.md`.
...
Ask Q1–Q9 from `../../questionnaires/code.questions.md` as structured questions. Batch where possible.
